...
export function SeasonScoresChart({ seasons }: SeasonScoresChartProps) {
  function createBackgroundGradient(context, color: string) {
    ...
    datasets: [
      {
        ...
        backgroundColor: (context) => createBackgroundGradient(context, '23, 64, 139'),
        fill: true,
        tension: 0.5
      },
      {
        ...
        backgroundColor: (context) => createBackgroundGradient(context, '201, 8, 42'),
        fill: true,
        tension: 0.5
      },
    ],
